...
export default defineConfig({
  entry: {
    ...
    'modules/canary/index': 'src/modules/canary/index.ts',
    'modules/content/index': 'src/modules/content/index.ts',
    'modules/hallucination/index': 'src/modules/hallucination/index.ts',
    'modules/ratelimit/index': 'src/modules/ratelimit/index.ts',
    'modules/audit/index': 'src/modules/audit/index.ts',
